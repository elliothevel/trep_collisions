...
class Puppet(trep.System):
    ...
    def add_string_constraints(self, shoulders=True, hands=True, knees=True):
        ...
        if shoulders:        
            ...
            strings.append([PuppetString(c1), PuppetString(c2)])
        ...
        if hands:    
            ...
            strings.append([PuppetString(c3), PuppetString(c4)])
        ...
        if knees:    
            ...
            strings.append([PuppetString(c5), PuppetString(c6)])

        self.strings = strings    


    def init_config(self):
        self.q = {'Frame Z': 24.0, 'TorsoZ': 10.0, 'LElbowTheta' : -np.pi/2, 'RElbowTheta' : -np.pi/2}
